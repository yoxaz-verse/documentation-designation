...
<iframe
  ...
  title="Company Research Specialist (CRS) – Role Guide"
  frameborder="0"
...
6. ⚠️ **Non-Qualified Companies Handling**  
   Use this form to mark non-qualified companies: [Non-Qualified Companies Form](https://docs.google.com/forms/d/1B8iGLyz7RIICl9NYsyv0a7ulgnNuNDee2QStbGPuvYw/edit#responses)  
   A company can be marked **non-qualified** only if:

   - ❌ It is **Closed**
   - ❌ It is **Not Agro-related**
   - ❌ It has **Insufficient Data (after full attempt)**
   - ❌ It is **Temporarily inactive**

   > ⚠️ You **cannot skip or reject** a company without proper **insufficient data justification**.  
   > Always attempt to collect data before marking it as non-qualified.

7. 📊 **Daily Reporting** – Update the team on:

   - ✅ Number of leads completed each day
   - ✅ Progress on datasets

8. 💬 **Stay Active on Zoho Cliq** – Always be responsive and available to coordinate with the team.
...
5. **Non-qualified companies** — can only be marked as such **with valid reason and proper documentation** using the [Non-Qualified Form](https://docs.google.com/forms/d/1B8iGLyz7RIICl9NYsyv0a7ulgnNuNDee2QStbGPuvYw/edit#responses).
6. **Stay accountable** — daily reporting is mandatory.
7. **Be responsive** — stay active and engaged on Cliq at all times.
